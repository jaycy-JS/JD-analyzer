...
**라이브 데모 →** `https://{username}.github.io/jd-analyzer`
...
```bash
git clone https://github.com/{username}/jd-analyzer.git
cd jd-analyzer
...
저장 후 약 1분 뒤 `https://{username}.github.io/jd-analyzer` 에서 접근 가능합니다.
